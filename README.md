...
- 🧑‍🤝‍🧑 **Multi-akun paksa** — `prompt=select_account` + `authuser=N` per tab, jadi tiap tab menarget akun berbeda (tab ke-n → `authuser=n-1`), bukan me-reuse akun aktif
